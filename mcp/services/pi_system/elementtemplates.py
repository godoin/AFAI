...
class ElementTemplates:
    ...
    def get(
        ...
        """
        Retrieves an element template using a web_id
        """
        if not web_id:
        ...
        return UserResponse.success(message=f"Successfully accessed the element template: {web_id}", response=response.json(), code=response.status_code)
    ...
    def get_by_path(
        ...
        return UserResponse.success(message="Successfully accessed the element template by path", response=response.json(), code=response.status_code)
